...
"use strict";
var _DonutMaker = _interopRequireDefault(require("./DonutMaker.js"));
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    "default": obj
  };
}
var donutMaker = new _DonutMaker["default"]();
...
var addToDonutCount = document.querySelector(".IncreaseDonutCountButton");
var donutDisplayCount = document.querySelector(".DonutCountDisplay");
var addToAutoClickerCount = document.querySelector(".PurchaseAutoClicks");
var autoClickerDisplay = document.querySelector(".AutoClickDisplay");
var buyMultiplier = document.querySelector(".PurchaseDonutMultiplier");
var multiplierDisplay = document.querySelector(".DonutMultiplierDisplay");
addToDonutCount.addEventListener("click", function () {
  donutMaker.addToDonutCount();
  donutDisplayCount.innerText = "Donut Count: " + Math.round(donutMaker.donutCount);
});
addToAutoClickerCount.addEventListener("click", function () {
...
},{"./DonutMaker.js":"6ixjb"}],"6ixjb":[function(require,module,exports) {
"use strict";
...
var DonutMaker = /*#__PURE__*/(function () {
  function DonutMaker(donutCount, donutMultiplier, autoClicker) {
    _classCallCheck(this, DonutMaker);
    this.donutCount = 0;
  ...
  _createClass(DonutMaker, [{
    key: "addToDonutCount",
    value: function addToDonutCount() {
      this.donutCount += Math.pow(1.2, this.donutMultiplier);
    }
  }, {
    key: "addToAutoClickerCount",
    value: function addToAutoClickerCount() {
      this.autoClicker += this.donutMultiplier;
      this.donutCount -= this.autoClickerCost;
      this.autoClickerCost = Math.round(this.autoClickerCost * 1.1);
    }
  }, {
    key: "activateAutoClicker",
    value: function activateAutoClicker() {
    ...
    key: "addToDonutMultiplierCount",
    value: function addToDonutMultiplierCount() {
...
exports["default"] = DonutMaker;

},{}]},["A7H4y","4ee1I"], "4ee1I", "parcelRequire24cb")
